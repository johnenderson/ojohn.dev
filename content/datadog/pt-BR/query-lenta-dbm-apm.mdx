...
Durante um laboratório de [Database Monitoring (DBM) do Datadog](https://www.datadoghq.com/product/database-monitoring/), investiguei um cenário assim: um widget exibia os itens mais pedidos de uma aplicação e, para manter esse ranking atualizado, uma query era executada a cada poucos segundos contra o PostgreSQL.
...
O ponto de partida foi a aba **Query Metrics** do [Database Monitoring](https://www.datadoghq.com/product/database-monitoring/).
...
<Image
  src="/datadog/query-lenta-dbm-apm/normalized-query.png"
...
<Image
  src="/datadog/query-lenta-dbm-apm/normalized-query-1.png"
...
<Image
  src="/datadog/query-lenta-dbm-apm/explain-plans.png"
...
<Image
  src="/datadog/query-lenta-dbm-apm/query-sample.png"
...
<Image
  src="/datadog/query-lenta-dbm-apm/trace_tab.png"
...
<Image
  src="/datadog/query-lenta-dbm-apm/percent_total_time.png"
...
O [Datadog Database Monitoring](https://www.datadoghq.com/product/database-monitoring/) não substitui conhecimento de banco de dados, mas melhora muito a qualidade da investigação.
...
- [Documentação do Database Monitoring do Datadog](https://docs.datadoghq.com/database_monitoring/)
- [Curso de Database Monitoring](https://learn.datadoghq.com/courses/database-monitoring)
